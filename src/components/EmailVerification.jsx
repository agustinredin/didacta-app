...
export default function EmailVerification() {
  ...
  //AGREGAR QUE SE PUEDA PEGAR UN NÚMERO DE 5 DÍGITOS Y SE COLOQUE EN TODOS LOS INPUTS. ACTUALMENTE SI PEGAS UN CÓDIGO, SE QUEDA EN EL PRIMER INPUT CON UN SOLO DÍGITO.
  return (
    <div className="max-w-sm mx-auto p-6 border rounded-lg shadow text-center">
      ...
      <button onClick={handleVerify} className="bg-blue-600 text-white px-4 py-2 rounded w-full hover:bg-blue-700">
        Verificar
      </button>
